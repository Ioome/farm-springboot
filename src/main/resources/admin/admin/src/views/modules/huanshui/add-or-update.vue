          ...
          <el-form-item class="input" label="种植日期" prop="zhongzhiriqi">
              <el-input v-model="ruleForm.zhongzhiriqi" 
                placeholder="种植日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="换水日期" prop="huanshuiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.huanshuiriqi" 
                type="date"
                placeholder="换水日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huanshuiriqi" label="换水日期" prop="huanshuiriqi">
              <el-input v-model="ruleForm.huanshuiriqi" 
                placeholder="换水日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="当前状态" prop="dangqianzhuangtai">
              <el-input v-model="ruleForm.dangqianzhuangtai" 
                placeholder="当前状态" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="下次换水" prop="xiacihuanshui">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.xiacihuanshui" 
                type="date"
                placeholder="下次换水">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiacihuanshui" label="下次换水" prop="xiacihuanshui">
              <el-input v-model="ruleForm.xiacihuanshui" 
                placeholder="下次换水" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhongzhiriqi = true;
            continue;
	            	            ...
	            	            if(o=='huanshuiriqi'){
            this.ruleForm.huanshuiriqi = obj[o];
	    this.ro.huanshuiriqi = true;
            continue;
          }
	    ...
	    this.ro.dangqianzhuangtai = true;
            continue;
	            	            ...
	            	            if(o=='xiacihuanshui'){
            this.ruleForm.xiacihuanshui = obj[o];
	    this.ro.xiacihuanshui = true;
            continue;
          }
	            	            if(o=='qita'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `huanshui/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huanshuiCrossAddOrUpdateFlag = false;
                  this.parent.search();
