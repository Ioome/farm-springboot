  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="土地名称" prop="tudimingcheng">
              <el-input v-model="ruleForm.tudimingcheng" 
                placeholder="土地名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="规模" prop="guimo">
          <el-input v-model="ruleForm.guimo" 
              placeholder="规模" clearable  :readonly="ro.guimo"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="状态" prop="zhuangtai">
              <el-input v-model="ruleForm.zhuangtai" 
                placeholder="状态" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="适合作物" prop="shihezuowu">
          <el-input v-model="ruleForm.shihezuowu" 
              placeholder="适合作物" clearable  :readonly="ro.shihezuowu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="适合作物" prop="shihezuowu">
              <el-input v-model="ruleForm.shihezuowu" 
                placeholder="适合作物" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="植物名称" prop="zhiwumingcheng">
          <el-select  @change="zhiwumingchengChange" v-model="ruleForm.zhiwumingcheng" placeholder="请选择植物名称">
            <el-option
                v-for="(item,index) in zhiwumingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.zhiwumingcheng" label="植物名称" prop="zhiwumingcheng">
          ...
          <el-form-item class="input" label="分类" prop="fenlei">
              <el-input v-model="ruleForm.fenlei" 
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="生长周期" prop="shengzhangzhouqi">
          <el-input v-model="ruleForm.shengzhangzhouqi" 
              placeholder="生长周期" clearable  :readonly="ro.shengzhangzhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="生长周期" prop="shengzhangzhouqi">
              <el-input v-model="ruleForm.shengzhangzhouqi" 
                placeholder="生长周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhiwutupian" label="植物图片" prop="zhiwutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhiwutupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="种植日期" prop="zhongzhiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhongzhiriqi" label="种植日期" prop="zhongzhiriqi">
              <el-input v-model="ruleForm.zhongzhiriqi" 
                placeholder="种植日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="收割日期" prop="shougeriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shougeriqi" 
                type="date"
                placeholder="收割日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shougeriqi" label="收割日期" prop="shougeriqi">
              <el-input v-model="ruleForm.shougeriqi" 
                placeholder="收割日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fenlei = true;
            continue;
	            	            ...
	            	            if(o=='shengzhangzhouqi'){
            this.ruleForm.shengzhangzhouqi = obj[o];
	    this.ro.shengzhangzhouqi = true;
            continue;
          }
	            	            if(o=='wendujianyi'){
	    ...
	    this.ro.zhongzhiriqi = true;
            continue;
	            	            ...
	            	            if(o=='shougeriqi'){
            this.ruleForm.shougeriqi = obj[o];
	    this.ro.shougeriqi = true;
            continue;
          }
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                            ...
                                                            // 下二随
    zhiwumingchengChange () {
      this.$http({
        url: `follow/zhiwu/zhiwumingcheng?columnValue=`+ this.ruleForm.zhiwumingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.fenlei){
                this.ruleForm.fenlei = data.data.fenlei
              }
                                                if(data.data.shengzhangzhouqi){
                this.ruleForm.shengzhangzhouqi = data.data.shengzhangzhouqi
              }
                                                if(data.data.wendujianyi){
                this.ruleForm.wendujianyi = data.data.wendujianyi
              }
                                                if(data.data.shidujianyi){
                this.ruleForm.shidujianyi = data.data.shidujianyi
              }
                                                                                                                                                                                                              } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhongzhi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhongzhiCrossAddOrUpdateFlag = false;
                  this.parent.search();
