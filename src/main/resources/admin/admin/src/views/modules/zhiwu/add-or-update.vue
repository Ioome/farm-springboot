      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="营养价值" prop="yingyangjiazhi">
          <el-input v-model="ruleForm.yingyangjiazhi" 
              placeholder="营养价值" clearable  :readonly="ro.yingyangjiazhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="营养价值" prop="yingyangjiazhi">
              <el-input v-model="ruleForm.yingyangjiazhi" 
                placeholder="营养价值" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="施肥品种" prop="shifeipinzhong">
          <el-select v-model="ruleForm.shifeipinzhong" placeholder="请选择施肥品种">
            <el-option
                v-for="(item,index) in shifeipinzhongOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="施肥品种" prop="shifeipinzhong">
	      <el-input v-model="ruleForm.shifeipinzhong"
                placeholder="施肥品种" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="光照周期" prop="guangzhaozhouqi">
          <el-input v-model="ruleForm.guangzhaozhouqi" 
              placeholder="光照周期" clearable  :readonly="ro.guangzhaozhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="光照周期" prop="guangzhaozhouqi">
              <el-input v-model="ruleForm.guangzhaozhouqi" 
                placeholder="光照周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="土壤要求" prop="turangyaoqiu">
          <el-input v-model="ruleForm.turangyaoqiu" 
              placeholder="土壤要求" clearable  :readonly="ro.turangyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="土壤要求" prop="turangyaoqiu">
              <el-input v-model="ruleForm.turangyaoqiu" 
                placeholder="土壤要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	shifeipinzhong : false,
	guangzhaozhouqi : false,
	turangyaoqiu : false,
	wendujianyi : false,
	shidujianyi : false,
	beizhu : false,
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yingyangjiazhi = true;
            continue;
	            	            ...
	            	            if(o=='shifeipinzhong'){
            this.ruleForm.shifeipinzhong = obj[o];
	    this.ro.shifeipinzhong = true;
            continue;
          }
	            	            if(o=='guangzhaozhouqi'){
            this.ruleForm.guangzhaozhouqi = obj[o];
	    this.ro.guangzhaozhouqi = true;
            continue;
          }
	            	            if(o=='turangyaoqiu'){
            this.ruleForm.turangyaoqiu = obj[o];
	    this.ro.turangyaoqiu = true;
            continue;
          }
	            	            if(o=='wendujianyi'){
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.fenleiOptions = "牙苗类,叶菜类,果菜类,球茎类,肉质类,茄果类,豆类,菌类,根茎类,瓜类".split(',')
                                                                                              this.shifeipinzhongOptions = "复合肥,磷肥,氮肥,钾肥".split(',')
                                                                                                                      },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
